...
public class Driver {
	...
	void displayNumberOfEmployees() {
		...
		System.out.println("Number of employees is: " + "5"+" (Look for other console messages.)"+n+CONTINUE);
	...
	void displayNumberOfCDsInBookstore(){
		//implement-- redo the implementation
		System.out.println("Number of CD's is " + "500"+" (Look for console messages.)"+n+CONTINUE);
