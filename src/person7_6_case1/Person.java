...
public class Person {
	...
	public static void main(String[] args) {
		GregorianCalendar dateOfBirth = new GregorianCalendar(2014, 5, 6);
		Person p1 = new Person("Samita", dateOfBirth);
		
		GregorianCalendar dateOfBirth1 = new GregorianCalendar(2014, 5, 6);
		Person p2 = new Person("Samita", dateOfBirth1);
